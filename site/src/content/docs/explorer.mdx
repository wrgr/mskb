...
<div class="tools-panel">
  ...
  <div class="tool-grid">
    <section class="tool-card" id="direct-search-card">
      <h4>Direct search</h4>
...
<script is:inline>
  // Relocate the Direct-Search tool card into the Starlight left sidebar so
  // it sits alongside the site menu instead of at the bottom of the page.
  // Falls back to leaving the card in place if the sidebar isn't found.
