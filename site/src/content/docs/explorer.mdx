...
template: splash
hero:
  tagline: Inspect papers, follow citation paths, and turn a short research note into parent/child/related paper choices.
sidebar:
  label: Explorer
  order: 5
---
...
<section class="paper-panel">
  ...
  <div class="rel-tabs explorer-rel-tabs">
    <input type="radio" name="explorer-rel" id="explorer-rel-parents" class="mskb-tab-input" checked />
    <input type="radio" name="explorer-rel" id="explorer-rel-children" class="mskb-tab-input" />
    <input type="radio" name="explorer-rel" id="explorer-rel-related" class="mskb-tab-input" />
    <div class="mskb-tab-labels rel-tab-labels" role="group" aria-label="Citation relationships">
      <label for="explorer-rel-parents">Parents</label>
      <label for="explorer-rel-children">Children</label>
      <label for="explorer-rel-related">Related</label>
    </div>
    <div class="rel-grid">
...
<div class="tools-panel">
  ...
  <div class="tools-tabs explorer-tools-tabs">
    <input type="radio" name="explorer-tools" id="explorer-tools-search" class="mskb-tab-input" checked />
    <input type="radio" name="explorer-tools" id="explorer-tools-idea" class="mskb-tab-input" />
    <div class="mskb-tab-labels tool-tab-labels" role="group" aria-label="Explorer tools">
      <label for="explorer-tools-search">Direct search</label>
      <label for="explorer-tools-idea">Find research like…</label>
    </div>
    <div class="tool-grid">
