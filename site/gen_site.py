...
def generate(config_path: str) -> None:
    ...
    # NOTE: explorer.md is now hand-authored in site/docs/explorer.md; the
    # old _write_explorer_page() Python template (1764 lines of embedded
    # sigma+graphology JS) used to overwrite that file on every build,
    # destroying manual edits. It was deleted when we migrated to
    # cytoscape and split explorer.js into its own files.
